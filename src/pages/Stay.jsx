    ...
    <main>
      <div className="container py-4">
        ...
        <div className="card mb-3 mt-3">
          <div className="row g-0">
            <div className="col-md-4">
              <img src={img1} className="img-fluid rounded-start" alt="img1" />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  luxurious aparment.Explore the rich history and beauty of the
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  transquility and stunning views while being surrounede by lush
                  forests and fresh mountains air.
                </p>
                <p className="card-text">
                  <small className="text-body-secondary">
        ...
        <div className="card mb-3 mt-3">
          <div className="row g-0">
            <div className="col-md-4">
              <img src={img3} className="img-fluid rounded-start" alt="img1" />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">
                ...
                <p className="card-text">
                  ...
                  pristine beaches, takes a dip in the private pool, and soak up
        ...
        <div className="card mb-3 mt-3">
          <div className="row g-0">
            <div className="col-md-4">
              <img src={img4} className="img-fluid rounded-start" alt="img1" />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  loft.Conveniently located in the city Center it. offer style,
