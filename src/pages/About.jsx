export default function About() {
  return (
    <main className="container py-4">
      <h1 className="fw-normal">About Airbnb</h1>
      <p>
      ...
      <p>
        ...
        experience at a time. Whether you're a host or a guest, we invite you to
        be a part of our vibrant community and embark on extraordinary
